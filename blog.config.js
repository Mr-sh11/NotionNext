...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'cc2760ecebff4f70bc81631d88207524',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mrsh1014', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'hack for fun', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'none', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'mrsh.tang@qq.com', // 邮箱地址 例如mail@tangly1024.com
